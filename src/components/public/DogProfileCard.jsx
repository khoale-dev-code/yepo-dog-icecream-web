      ...
      >
        ...
        >
          ...
          <button
            type="button"
            onClick={onClose}
            className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-white/90 text-[#8c672f] transition hover:bg-white"
          ...
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1.1fr)_420px]">
            <div className="min-w-0">
              <div
                ...
                className="relative overflow-hidden rounded-[30px] border-[6px] border-white p-3 shadow-inner"
              >
                <div className="aspect-[4/3] overflow-hidden rounded-[22px] bg-white/45">
                  {activeMedia ? (
                ...
                {media.length > 1 && (
                  <>
                    <button
                      type="button"
                      onClick={goPrevious}
                      className="absolute left-5 top-1/2 grid h-11 w-11 -translate-y-1/2 place-items-center rounded-full bg-white/90 text-[#8c672f] shadow-md transition hover:bg-white"
                    ...
                    <button
                      type="button"
                      onClick={goNext}
                      className="absolute right-5 top-1/2 grid h-11 w-11 -translate-y-1/2 place-items-center rounded-full bg-white/90 text-[#8c672f] shadow-md transition hover:bg-white"
            ...
            >
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <DetailBox
                  label="Cân nặng"
                  value={dog?.weightKg ? `${dog.weightKg} kg` : "Chưa cập nhật"}
                  icon={<Weight size={15} />}
                />
                <DetailBox
                  label="Độ dễ thương"
                  value={`${dog?.cutenessLevel || 70}/100`}
                />
                <DetailBox
                  label="Kiểu lông"
