...
const newMediaCarousel = String.raw`function MediaCarousel({ media = [], mode = "modal" }) {
  ...
  return (
    <div
      className={[
        "relative isolate overflow-hidden bg-[#111] select-none",
        isPageMode
          ? "h-[72dvh] min-h-[340px] max-h-[680px] w-full sm:h-[78vh] sm:max-h-[760px]"
...
console.log("✅ Fixed post detail media full display:", postsFile);
